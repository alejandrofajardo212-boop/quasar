  ...
  <q-layout view="lHh Lpr lFf">
    ...
    <q-page-container class="bg-grey-2">
      <q-page class="q-pa-md">
        ...
        <!-- LISTADO DE TARJETAS DE SERVICIO -->
          ...
          <div v-for="s in servicios" :key="s.id" class="col-12 col-sm-6 col-md-4">
            <q-card flat bordered class="shadow-2" :class="{
              ...
              <q-card-section class="q-py-md text-body1">
                ...
                <!-- MOSTRAR DETALLES ADICIONALES EN LA TARJETA -->
                <div v-if="s.descripcion" class="q-mb-xs text-body2 bg-grey-3 text-grey-9 q-pa-xs rounded-borders">
                  <q-icon name="info" size="18px" color="primary" /> <strong>Detalles / Estado:</strong> {{ s.descripcion }}
                </div>
                ...
                <div v-if="s.estadoEquipo === 'Entregado'" class="q-mt-md bg-amber-2 q-pa-sm rounded-borders">
                  <div class="row items-center">
                    ...
                    <q-rating v-model="s.calificacion" max="5" size="1.4em" color="orange" readonly class="cursor-pointer" />
                  </div>
          ...
          <q-card style="width: 460px; max-width: 90vw;">
            ...
            <q-card-section class="q-pa-md q-gutter-y-md" v-if="curServicio">
              ...
              <div v-if="curServicio.estadoEquipo === 'Entregado' && getPendiente(curServicio) === 0" class="bg-amber-1 q-pa-md rounded-borders text-center q-gutter-y-sm">
                ...
                <q-rating v-model="curServicio.calificacion" max="5" size="2em" color="orange" class="cursor-pointer" />
        ...
        <q-dialog v-model="modalForm" persistent>
          <q-card style="width: 620px; max-width: 90vw;">
            ...
            <q-form @submit="saveServicio" class="q-gutter-md q-pa-md">
              ...
              <div class="row q-col-gutter-sm">
                ...
                <div class="col-6">
                  <q-input 
                    ...
                    outlined 
                    dense 
                    :rules="[val => !!val && val.trim() !== '' || 'El modelo es obligatorio']" 
                  />
                </div>
              </div>
              ...
              <div class="row q-col-gutter-sm">
                <div class="col-6">
                  <q-select 
                    ...
                    outlined 
                    dense 
                    :rules="[val => !!val || 'Seleccione la reparación']" 
                  />
                </div>
                <div class="col-6">
                  <q-select 
              ...
              <!-- 5. DETALLES ADICIONALES / ESTADO INICIAL (OPCIONAL) UBICADO DEBAJO DE REPARACIÓN Y TÉCNICO -->
              <q-input 
                v-model="form.descripcion" 
                label="Detalles adicionales del equipo / Estado inicial (Opcional)" 
                type="textarea" 
                rows="2" 
                outlined 
                dense 
                placeholder="Ej: Tiene rayones en la tapa, cámara rota aparte del cambio de pantalla, etc."
              />

              <!-- 6. FECHA, PRECIO Y ABONO -->
              <div class="row q-col-gutter-sm">
                <div class="col-4">
                ...
                <div class="col-4">
                  <q-input 
                    ...
                    outlined 
                    dense 
                    :rules="[val => (val !== null && val !== '' && val >= 0) || 'Ingrese un precio válido (>= 0)']" 
                  />
                </div>
                <div class="col-4">
                  <q-input 
                    v-model.number="form.montoPagado" 
                    label="Abono ($) *" 
                    type="number" 
                    outlined 
                    dense 
                    :rules="[
                      val => (val !== null && val !== '' && val >= 0) || 'El abono debe ser >= 0',
                      val => val <= (form.precio || 0) || 'El abono excede el precio'
                    ]" 
                  />
                </div>
              </div>

              <!-- 7. MÉTODO PAGO Y ESTADO -->
              <div class="row q-col-gutter-sm">
                <div class="col-6">
                  <q-select 
                    ...
                    outlined 
                    dense 
                    :rules="[val => !!val || 'Seleccione método de pago']" 
                  />
                </div>
                <div class="col-6">
                  <q-select 
              ...
              <!-- CALIFICACIÓN SOLO SI ES 'ENTREGADO' -->
              <div v-if="form.estadoEquipo === 'Entregado' && getPendiente(form) === 0" class="q-pa-sm bg-amber-1 rounded-borders text-center q-gutter-y-xs">
                ...
                <q-rating v-model="form.calificacion" max="5" size="1.8em" color="orange" class="cursor-pointer" />
...
/* FORZAR CURSOR DE MANITO EN LAS ESTRELLAS */
:deep(.q-rating), :deep(.q-rating__icon) {
  cursor: pointer !important;
}

/* FORZAR CURSOR DE TEXTO EN EL ÁREA DE RESEÑA Y CAMPOS DE TEXTO */
